...
//        num1 = 80;                    // initializing number at start-up; this will be read-in from slider bar for updating chart
        KK = 21500;                     // initial value for carrying capacity
        K_mult = 1.0;                   // Carrying Capacity multiplier

        phi_fem = 0.99;                 // Sex ratio of historic commercial catch (ie. 1.0 = 100% females)
        beta_cow = 0.99;                // Proportion (mature) females in commercial catch that were cows w/calves
        ...
        CV_Add = 0.20;                   // additional variation about abundance estimates, not taken into account by survey methodology
...
////////////////////////////////////////////////////////////////////////////////
        ...
        panel_2.add(jTextField18);

        xpos = 6; ypos = 12;             // Label pos.
        constraints.gridx = xpos;
        constraints.gridy = ypos;
        ...
        panel_2.add(label_18);             // see if can add a label here.
...
////////////////////////////////////////////////////////////////////////////////
        ...
        panel_2.add(label_1);             // see if can add a label here.
...
////////////////////////////////////////////////////////////////////////////////
        ...
        panel_2.add(label_3);             // see if can add a label here.
...
////////////////////////////////////////////////////////////////////////////////
        ...
        constraints.anchor = GridBagConstraints.CENTER;
        constraints.fill = GridBagConstraints.NONE;
        JLabel label_6 = new JLabel("Proportion female lagoon catch: cows w/calves");    // test label while debugging the layout
...
////////////////////////////////////////////////////////////////////////////////
        ...
        panel_2.add(label_4);             // see if can add a label here.
...
//////////////////////////////////////////////////////////////////////////////////
        ...
        panel_2.add(jTextField15);

        xpos = 4; ypos = 12;             // Label .
        constraints.gridx = xpos;
        constraints.gridy = ypos;
        constraints.insets = new Insets(lt,ll,lb,lr);
        constraints.anchor = GridBagConstraints.CENTER;
        ...
        panel_2.add(label_15);             // see if can add a label here.
...
////////////////////////////////////////////////////////////////////////////////
        ...
        label_77.setToolTipText("The annual survival rate of animals aged one year and older (i.e. all ages except calves)");
        label_77.setEnabled(false);
        gbl.setConstraints(label_77, constraints);
        panel_2.add(label_77);             // see if can add a label here.
...
////////////////////////////////////////////////////////////////////////////////
// 1+ SURVIVAL RATE (Pre-1900 if Radio Button selection dictates)
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
        ...
        panel_2.add(jTextField17);

        xpos = 6; ypos = 9;             // Label pos.
        constraints.gridx = xpos;
        constraints.gridy = ypos;
        constraints.insets = new Insets(lt,ll,lb,lr);
        constraints.anchor = GridBagConstraints.CENTER;
        constraints.fill = GridBagConstraints.NONE;
        final JLabel label_17 = new JLabel("Catch Multiplier Pre-1900");    // test label while debugging the layout
        label_17.setToolTipText("Multiplies the removals (all fisheries combined) before 1900.");
        gbl.setConstraints(label_17, constraints);
        panel_2.add(label_17);             // see if can add a label here.
...
//        JRadioButton rb2 = new JRadioButton("Two Survival Rates", false);
        ...
        rb2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
               label_7.setText("Age 1+ Survival Pre-1900");
               label_7.setToolTipText("The annual survival rate of animals aged one year and older (i.e. all ages except calves) pre-1900.");
...
//        catchFemaleComm[1][0] = 45;                  // Year 0 = 1846
//        catchFemaleComm[1][1] = 45;
//        catchFemaleComm[1][2] = 45;
//        catchFemaleComm[1][3] = 45;
//        catchFemaleComm[1][4] = 45;
//        catchFemaleComm[1][5] = 45;
//        catchFemaleComm[1][6] = 45;
//        catchFemaleComm[1][7] = 45;
//        catchFemaleComm[1][8] = 45;
//        catchFemaleComm[1][9] = 324;
//        catchFemaleComm[1][10] = 324;
//        catchFemaleComm[1][11] = 324;
//        catchFemaleComm[1][12] = 324;
//        catchFemaleComm[1][13] = 324;
//        catchFemaleComm[1][14] = 324;
//        catchFemaleComm[1][15] = 324;
//        catchFemaleComm[1][16] = 324;
//        catchFemaleComm[1][17] = 324;
//        catchFemaleComm[1][18] = 324;
//        catchFemaleComm[1][19] = 324;
//        catchFemaleComm[1][20] = 159;
//        catchFemaleComm[1][21] = 159;
//        catchFemaleComm[1][22] = 159;
//        catchFemaleComm[1][23] = 159;
//        catchFemaleComm[1][24] = 159;
//        catchFemaleComm[1][25] = 159;
//        catchFemaleComm[1][26] = 159;
//        catchFemaleComm[1][27] = 159;
//        catchFemaleComm[1][28] = 159;
//        catchFemaleComm[1][29] = 33;
//        catchFemaleComm[1][30] = 33;
//        catchFemaleComm[1][31] = 33;
//        catchFemaleComm[1][32] = 33;
//        catchFemaleComm[1][33] = 42;
//        catchFemaleComm[1][34] = 34;
//        catchFemaleComm[1][35] = 33;
//        catchFemaleComm[1][36] = 33;
//        catchFemaleComm[1][37] = 39;
//        catchFemaleComm[1][38] = 45;
//        catchFemaleComm[1][39] = 41;
//        catchFemaleComm[1][40] = 33;
//        catchFemaleComm[1][41] = 13;
//        catchFemaleComm[1][42] = 13;
//        catchFemaleComm[1][43] = 13;
//        catchFemaleComm[1][44] = 13;
//        catchFemaleComm[1][45] = 13;
//        catchFemaleComm[1][46] = 13;
//        catchFemaleComm[1][47] = 0;
//        catchFemaleComm[1][48] = 0;
//        catchFemaleComm[1][49] = 0;
//        catchFemaleComm[1][50] = 0;
//        catchFemaleComm[1][51] = 0;
//        catchFemaleComm[1][52] = 0;
//        catchFemaleComm[1][53] = 0;
//        catchFemaleComm[1][54] = 0;
//        catchFemaleComm[1][55] = 0;
//        catchFemaleComm[1][56] = 0;
//        catchFemaleComm[1][57] = 0;
//        catchFemaleComm[1][58] = 0;
//        catchFemaleComm[1][59] = 0;
//        catchFemaleComm[1][60] = 0;
//        catchFemaleComm[1][61] = 0;
//        catchFemaleComm[1][62] = 0;
//        catchFemaleComm[1][63] = 0;
//        catchFemaleComm[1][64] = 1;
//        catchFemaleComm[1][65] = 1;
//        catchFemaleComm[1][66] = 0;
//        catchFemaleComm[1][67] = 1;
//        catchFemaleComm[1][68] = 13;
//        catchFemaleComm[1][69] = 0;
//        catchFemaleComm[1][70] = 0;
//        catchFemaleComm[1][71] = 0;
//        catchFemaleComm[1][72] = 0;
//        catchFemaleComm[1][73] = 0;
//        catchFemaleComm[1][74] = 1;
//        catchFemaleComm[1][75] = 25;
//        catchFemaleComm[1][76] = 4;
//        catchFemaleComm[1][77] = 0;
//        catchFemaleComm[1][78] = 0;
//        catchFemaleComm[1][79] = 64;
//        catchFemaleComm[1][80] = 17;
//        catchFemaleComm[1][81] = 25;
//        catchFemaleComm[1][82] = 8;
//        catchFemaleComm[1][83] = 3;
//        catchFemaleComm[1][84] = 0;
//        catchFemaleComm[1][85] = 0;
//        catchFemaleComm[1][86] = 7;
//        catchFemaleComm[1][87] = 69;
//        catchFemaleComm[1][88] = 92;
//        catchFemaleComm[1][89] = 96;
//        catchFemaleComm[1][90] = 114;
//        catchFemaleComm[1][91] = 9;
//        catchFemaleComm[1][92] = 36;
//        catchFemaleComm[1][93] = 19;
//        catchFemaleComm[1][94] = 66;
//        catchFemaleComm[1][95] = 38;
//        catchFemaleComm[1][96] = 67;
//        catchFemaleComm[1][97] = 66;
//        catchFemaleComm[1][98] = 0;
//        catchFemaleComm[1][99] = 20;
//        catchFemaleComm[1][100] = 15;
//        catchFemaleComm[1][101] = 1;
//        catchFemaleComm[1][102] = 13;
//        catchFemaleComm[1][103] = 17;
//        catchFemaleComm[1][104] = 7;
//        catchFemaleComm[1][105] = 9;
//        catchFemaleComm[1][106] = 29;
//        catchFemaleComm[1][107] = 29;
//        catchFemaleComm[1][108] = 26;
//        catchFemaleComm[1][109] = 39;
//        catchFemaleComm[1][110] = 81;
//        catchFemaleComm[1][111] = 64;
//        catchFemaleComm[1][112] = 99;
//        catchFemaleComm[1][113] = 130;
//        catchFemaleComm[1][114] = 104;
//        catchFemaleComm[1][115] = 139;
//        catchFemaleComm[1][116] = 98;
//        catchFemaleComm[1][117] = 120;
//        catchFemaleComm[1][118] = 138;
//        catchFemaleComm[1][119] = 110;
//        catchFemaleComm[1][120] = 120;
//        catchFemaleComm[1][121] = 223;
//        catchFemaleComm[1][122] = 109;
//        catchFemaleComm[1][123] = 121;
//        catchFemaleComm[1][124] = 81;
//        catchFemaleComm[1][125] = 91;
//        catchFemaleComm[1][126] = 116;
//        catchFemaleComm[1][127] = 80;
//        catchFemaleComm[1][128] = 90;
//        catchFemaleComm[1][129] = 113;
//        catchFemaleComm[1][130] = 96;
//        catchFemaleComm[1][131] = 101;
//        catchFemaleComm[1][132] = 90;
//        catchFemaleComm[1][133] = 126;
//        catchFemaleComm[1][134] = 129;
//        catchFemaleComm[1][135] = 100;
//        catchFemaleComm[1][136] = 112;
//        catchFemaleComm[1][137] = 125;
//        catchFemaleComm[1][138] = 110;
//        catchFemaleComm[1][139] = 115;
//        catchFemaleComm[1][140] = 125;
//        catchFemaleComm[1][141] = 112;
//        catchFemaleComm[1][142] = 108;
//        catchFemaleComm[1][143] = 119;
//        catchFemaleComm[1][144] = 95;
//        catchFemaleComm[1][145] = 100;
//        catchFemaleComm[1][146] = 0;
//        catchFemaleComm[1][147] = 0;
//        catchFemaleComm[1][148] = 23;
//        catchFemaleComm[1][149] = 44;
//        catchFemaleComm[1][150] = 25;
//        catchFemaleComm[1][151] = 31;
//        catchFemaleComm[1][152] = 61;
//        catchFemaleComm[1][153] = 55;
//        catchFemaleComm[1][154] = 52;
//        catchFemaleComm[1][155] = 50;
//        catchFemaleComm[1][156] = 51;
//        catchFemaleComm[1][157] = 57;
//        catchFemaleComm[1][158] = 68;
//        catchFemaleComm[1][159] = 75;
//        catchFemaleComm[1][160] = 77;
//        catchFemaleComm[1][161] = 82;
//        catchFemaleComm[1][162] = 66;
//
//        catchMaleComm[1][0] = 23;
//        catchMaleComm[1][1] = 23;
//        catchMaleComm[1][2] = 23;
//        catchMaleComm[1][3] = 23;
//        catchMaleComm[1][4] = 23;
//        catchMaleComm[1][5] = 23;
//        catchMaleComm[1][6] = 23;
//        catchMaleComm[1][7] = 23;
//        catchMaleComm[1][8] = 23;
//        catchMaleComm[1][9] = 162;
//        catchMaleComm[1][10] = 162;
//        catchMaleComm[1][11] = 162;
//        catchMaleComm[1][12] = 162;
//        catchMaleComm[1][13] = 162;
//        catchMaleComm[1][14] = 162;
//        catchMaleComm[1][15] = 162;
//        catchMaleComm[1][16] = 162;
//        catchMaleComm[1][17] = 162;
//        catchMaleComm[1][18] = 162;
//        catchMaleComm[1][19] = 162;
//        catchMaleComm[1][20] = 79;
//        catchMaleComm[1][21] = 79;
//        catchMaleComm[1][22] = 79;
//        catchMaleComm[1][23] = 79;
//        catchMaleComm[1][24] = 79;
//        catchMaleComm[1][25] = 79;
//        catchMaleComm[1][26] = 79;
//        catchMaleComm[1][27] = 79;
//        catchMaleComm[1][28] = 79;
//        catchMaleComm[1][29] = 17;
//        catchMaleComm[1][30] = 17;
//        catchMaleComm[1][31] = 17;
//        catchMaleComm[1][32] = 17;
//        catchMaleComm[1][33] = 21;
//        catchMaleComm[1][34] = 17;
//        catchMaleComm[1][35] = 17;
//        catchMaleComm[1][36] = 17;
//        catchMaleComm[1][37] = 19;
//        catchMaleComm[1][38] = 23;
//        catchMaleComm[1][39] = 21;
//        catchMaleComm[1][40] = 17;
//        catchMaleComm[1][41] = 7;
//        catchMaleComm[1][42] = 7;
//        catchMaleComm[1][43] = 7;
//        catchMaleComm[1][44] = 7;
//        catchMaleComm[1][45] = 7;
//        catchMaleComm[1][46] = 7;
//        catchMaleComm[1][47] = 0;
//        catchMaleComm[1][48] = 0;
//        catchMaleComm[1][49] = 0;
//        catchMaleComm[1][50] = 0;
//        catchMaleComm[1][51] = 0;
//        catchMaleComm[1][52] = 0;
//        catchMaleComm[1][53] = 0;
//        catchMaleComm[1][54] = 0;
//        catchMaleComm[1][55] = 0;
//        catchMaleComm[1][56] = 0;
//        catchMaleComm[1][57] = 0;
//        catchMaleComm[1][58] = 0;
//        catchMaleComm[1][59] = 0;
//        catchMaleComm[1][60] = 0;
//        catchMaleComm[1][61] = 0;
//        catchMaleComm[1][62] = 0;
//        catchMaleComm[1][63] = 0;
//        catchMaleComm[1][64] = 0;
//        catchMaleComm[1][65] = 0;
//        catchMaleComm[1][66] = 0;
//        catchMaleComm[1][67] = 0;
//        catchMaleComm[1][68] = 6;
//        catchMaleComm[1][69] = 0;
//        catchMaleComm[1][70] = 0;
//        catchMaleComm[1][71] = 0;
//        catchMaleComm[1][72] = 0;
//        catchMaleComm[1][73] = 0;
//        catchMaleComm[1][74] = 1;
//        catchMaleComm[1][75] = 13;
//        catchMaleComm[1][76] = 6;
//        catchMaleComm[1][77] = 0;
//        catchMaleComm[1][78] = 1;
//        catchMaleComm[1][79] = 70;
//        catchMaleComm[1][80] = 25;
//        catchMaleComm[1][81] = 7;
//        catchMaleComm[1][82] = 4;
//        catchMaleComm[1][83] = 0;
//        catchMaleComm[1][84] = 0;
//        catchMaleComm[1][85] = 0;
//        catchMaleComm[1][86] = 3;
//        catchMaleComm[1][87] = 36;
//        catchMaleComm[1][88] = 64;
//        catchMaleComm[1][89] = 48;
//        catchMaleComm[1][90] = 74;
//        catchMaleComm[1][91] = 5;
//        catchMaleComm[1][92] = 18;
//        catchMaleComm[1][93] = 10;
//        catchMaleComm[1][94] = 39;
//        catchMaleComm[1][95] = 19;
//        catchMaleComm[1][96] = 34;
//        catchMaleComm[1][97] = 33;
//        catchMaleComm[1][98] = 0;
//        catchMaleComm[1][99] = 10;
//        catchMaleComm[1][100] = 7;
//        catchMaleComm[1][101] = 0;
//        catchMaleComm[1][102] = 6;
//        catchMaleComm[1][103] = 9;
//        catchMaleComm[1][104] = 4;
//        catchMaleComm[1][105] = 5;
//        catchMaleComm[1][106] = 15;
//        catchMaleComm[1][107] = 19;
//        catchMaleComm[1][108] = 13;
//        catchMaleComm[1][109] = 20;
//        catchMaleComm[1][110] = 41;
//        catchMaleComm[1][111] = 32;
//        catchMaleComm[1][112] = 49;
//        catchMaleComm[1][113] = 66;
//        catchMaleComm[1][114] = 52;
//        catchMaleComm[1][115] = 69;
//        catchMaleComm[1][116] = 53;
//        catchMaleComm[1][117] = 60;
//        catchMaleComm[1][118] = 81;
//        catchMaleComm[1][119] = 71;
//        catchMaleComm[1][120] = 100;
//        catchMaleComm[1][121] = 151;
//        catchMaleComm[1][122] = 92;
//        catchMaleComm[1][123] = 93;
//        catchMaleComm[1][124] = 70;
//        catchMaleComm[1][125] = 62;
//        catchMaleComm[1][126] = 66;
//        catchMaleComm[1][127] = 98;
//        catchMaleComm[1][128] = 94;
//        catchMaleComm[1][129] = 58;
//        catchMaleComm[1][130] = 69;
//        catchMaleComm[1][131] = 86;
//        catchMaleComm[1][132] = 94;
//        catchMaleComm[1][133] = 57;
//        catchMaleComm[1][134] = 53;
//        catchMaleComm[1][135] = 36;
//        catchMaleComm[1][136] = 56;
//        catchMaleComm[1][137] = 46;
//        catchMaleComm[1][138] = 59;
//        catchMaleComm[1][139] = 55;
//        catchMaleComm[1][140] = 46;
//        catchMaleComm[1][141] = 47;
//        catchMaleComm[1][142] = 43;
//        catchMaleComm[1][143] = 61;
//        catchMaleComm[1][144] = 67;
//        catchMaleComm[1][145] = 69;
//        catchMaleComm[1][146] = 0;
//        catchMaleComm[1][147] = 0;
//        catchMaleComm[1][148] = 21;
//        catchMaleComm[1][149] = 48;
//        catchMaleComm[1][150] = 18;
//        catchMaleComm[1][151] = 48;
//        catchMaleComm[1][152] = 64;
//        catchMaleComm[1][153] = 69;
//        catchMaleComm[1][154] = 63;
//        catchMaleComm[1][155] = 62;
//        catchMaleComm[1][156] = 80;
//        catchMaleComm[1][157] = 71;
//        catchMaleComm[1][158] = 43;
//        catchMaleComm[1][159] = 49;
//        catchMaleComm[1][160] = 57;
//        catchMaleComm[1][161] = 50;
//        catchMaleComm[1][162] = 64;
